...
- Order and exposure limits: `MIN_ORDER_QUOTE_USDT`, `MIN_TRADE_PCT`, `MIN_TRADE_QUOTE_BUFFER_PCT`, `MAX_OPEN_POSITIONS`, `MAX_SYMBOL_EXPOSURE_PCT`, `MAX_TOTAL_EXPOSURE_PCT`, `MAX_SINGLE_TRADE_PCT`
